...
#define PUBLIC_ID_METER16       2
#define PUBLIC_ID_METER32       3
#define PUBLIC_ID_METER64       4
#define PUBLIC_ID_POWER_METER16 5
#define PUBLIC_ID_POWER_METER32 6
#define PUBLIC_ID_POWER_METER64 7
#define PUBLIC_ID_PWM           8
